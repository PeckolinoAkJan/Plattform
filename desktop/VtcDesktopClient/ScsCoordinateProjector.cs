...
/// <summary>
/// Converts SCS X/Z world placement into WGS84-style latitude/longitude values.
/// The constants are the map projection values shipped in the current ETS2 and
/// ATS def/climate.sii files. Both games use a Lambert conformal conic projection.
/// </summary>
public static class ScsCoordinateProjector
{
    ...
    public static bool TryProject(string? game, double x, double z, out ProjectedCoordinate coordinate)
    {
        ...
        coordinate = new ProjectedCoordinate(
            latitude,
            longitude,
            "SCS map projection (Lambert conformal conic)");
        return true;
    }
        ...
        out double longitude)
    {
        ...
        // SCS map_factor values are angular plane units per game-world unit.
